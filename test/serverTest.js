    ...
    it('gives correct reason for kicking clients when shutting down', function (done) {
      ...
      server.on('login', function (client) {
        ...
        const loginPacket = {
          ...
          previousGameMode: version.version >= 755 ? 0 : 255,
          worldNames: ['minecraft:overworld'],
          dimensionCodec: version.version >= 755 ? mcData.loginPacket.dimensionCodec : (version.version >= 735 ? mcData.loginPacket.dimension : { name: '', type: 'compound', value: { dimension: { type: 'list', value: { type: 'compound', value: [w] } } } }),          dimension: (version.version >= 735 ? mcData.loginPacket.dimension : 0),
          dimension: (version.version >= 735 ? mcData.loginPacket.dimension : 0),
          worldName: 'minecraft:overworld',
          hashedSeed: [0, 0],
          difficulty: 2,
